...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    "version" : "14.0.0.8",
    "depends" : ['web','base','account','purchase','sale_management','stock','account_accountant'],
    "author": "BrowseInfo",
    ...
    'assets': {
        'web.assets_backend': ['bi_manual_currency_exchange_rate/static/src/js/reconciliation_renderer.js',         
        ],
        'web.assets_qweb':['bi_manual_currency_exchange_rate/static/src/xml/account_reconciliation.xml',
    ],
    },
    "auto_install": False,
    "installable": True,
