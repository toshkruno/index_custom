...
class AccountPaymentOrder(models.Model):
    ...
    state = fields.Selection(
        selection=[
            ("draft", "Draft"),
            ("open", "Payment Requested"),
            ("generated", "Payment Details Confirmed"),
            ("uploaded", "Approved"),
            ("cancel", "Cancel"),
        ],
        string="Status",
    ...
    date_generated = fields.Date(string="Date Confirmed", readonly=True)
    date_uploaded = fields.Date(string="Date Approved", readonly=True)
    # requested_by = fields.Char(string="Request")
    ...
    description = fields.Char(string='Cheque No')
