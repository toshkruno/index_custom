...
class AccountPaymentLine(models.Model):
    ...
    amount_residual = fields.Monetary(related="move_line_id.credit", currency_field="currency_id")
    amount_2 = fields.Monetary(related="move_line_id.amount_untax", currency_field="currency_id")
